...
// Backend property structure (matches properties.controller.js)
...
export interface Property {
  id: number | string;
  // Support both backend (name) and frontend (title) structures
  name?: string;
  title?: string;
  description?: string;
  price: number;
  location: string;
  image?: string; // Frontend mock data uses this
  coordinates?: {
    lat: number;
    lng: number;
  };
  images?: string[]; // Backend uses this
  amenities?: string[];
  bedrooms?: number;
  bathrooms?: number;
  maxGuests?: number;
